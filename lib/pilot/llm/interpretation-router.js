...
const PMS_INTERPRETATION_FIELDS = Object.freeze([
  ...
  'exception_request', 'cancellation_request', 'payment_reported', 'uncertainty', 'needs_clarification', 'missing_fields',
  // Experimento "el LLM escribe" (2026-09-24): senales V2 que el PMS ya acepta.
  'ambiguity', 'unmapped_meaning', 'duration_kind', 'guest_composition', 'visitors_question', 'references'
]);
