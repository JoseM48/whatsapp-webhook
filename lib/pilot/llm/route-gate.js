...
//
// LA ALLOWLIST DEJA DE SER REQUISITO (2026-09-23, Plan Padrino). Era la
// herramienta de D1: un solo telefono de prueba mientras se validaba la ruta.
// Para una campana no sirve, porque los telefonos de los leads son
// desconocidos de antemano y ninguna lista puede contenerlos. Mantenerla
// habria significado que la pauta entera cayera a legacy -- es decir, que
// nada de lo validado le aplicara a un lead real.
//
// La bandera global es ahora el unico interruptor: encendida, cualquier
// huesped entra; apagada, todos caen a legacy.
//
// EL TELEFONO INTERNO NO PUEDE ENTRAR POR AQUI, y no depende de esta funcion:
// `isControl()` atrapa cualquier mensaje suyo antes, en index.js, y lo manda
// al camino de comandos internos. Esta compuerta solo ve trafico de huesped.
...
function evaluateConversationalRoute(phone, env = process.env) {
  ...
  return { allowed: true, reason: 'route_enabled' };
}
