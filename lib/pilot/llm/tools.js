...
const READ_TOOLS = [
  ...
  },
  {
    ...
    description: 'Consulta disponibilidad real para unas fechas y duración. Requiere fecha de llegada exacta; si falta, devuelve needs_clarification.',
    parameters: {
      type: 'object', additionalProperties: false,
      properties: {
  ...
  {
    name: 'quote_stay',
    description: 'Cotiza una estadía según las políticas vigentes (escalones de duración, horizonte, póliza). El precio SIEMPRE viene de aquí: el modelo nunca lo calcula ni lo estima.',
    parameters: {
      type: 'object', additionalProperties: false,
      properties: {
        nights: { type: ['integer', 'null'] },
...
module.exports = {
  READ_TOOLS, ACTION_COMMANDS, ACTION_NAMES,
