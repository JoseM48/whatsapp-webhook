...
const BRIDGE_BACKED = new Set([
  ...
  // Anadida el 2026-09-22 tras D0: de diez consultas que respondieron
  // `policy_not_published`, cuatro tenian respuesta publicada en
  // content_units. Ya existe en el puente.
  'search_commercial_knowledge'
]);
