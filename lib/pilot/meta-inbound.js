    ...
    for (const change of entry?.changes || []) {
      ...
      for (const message of value.messages || []) {
        ...
        result.push({
          ...
          // Investigacion 2026-09-09 (Jose Manuel): confirmar si Meta manda
          // este dato en un click-to-WhatsApp real antes de decidir si se
          // usa para atribuir origen -- nunca contiene datos del cliente,
          // solo metadatos del anuncio (source_id/source_type/headline).
