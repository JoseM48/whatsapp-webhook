  ...
  async present({ decision, phone }) {
    ...
    try {
      ...
      return await this.structured({
        ...
        system: 'Write a concise WhatsApp response using only the supplied authorized context. Never claim confirmed availability, confirmed/final price, reservation, payment, policy, access code, or Wi-Fi credential. If options are shown, explicitly state that availability and price require Reservations confirmation. Return only IDs present in the context.',
