...
const interpretationSchema = {
  ...
  required: [
    ...
    'requests_human', 'exception_request', 'cancellation_request', 'uncertainty', 'needs_clarification', 'missing_fields'
  ]
};
