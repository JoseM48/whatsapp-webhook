...
function deterministicInterpret(text, { today, context = {} } = {}) {
  ...
  const exceptionRequest = /descuento|rebaja|negociar|negociaci[oó]n|promoci[oó]n|precio especial|condici[oó]n especial|condiciones especiales|plan de pago|sin penalidad|m[aá]s barato|mejor precio|cliente frecuente|excepci[oó]n|trato especial/i.test(text);
